...
is 'Returns open shared transfer items for expenses that have occurred, where payer_user_id is the debtor who should transfer and payee_user_id is the original paid_by recipient.';
